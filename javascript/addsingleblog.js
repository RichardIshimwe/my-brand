...
// let addImage_holder;
// window.alert("added blog connected");
...
function addblog() {
    ...
    //     }
    // }
    let holdtemplary = localStorage.getItem('images');
    localStorage.setItem('restoredimage',holdtemplary)
    console.log(holdtemplary);
    // let blogsContent = {
    //     title: add_title.value,
    //     description: add_textarea.value,
    //     image: addImage_holder
    ...
    //     console.log(add_textarea.value);
    //     console.log(addImage_holder)
    // hold_blogs = JSON.parse(localStorage.getItem('hold_blogs')) || [];//find a way to concantinate dummy content in local storage
    // hold_blogs.unshift(blogsContent);
    // localStorage.setItem('hold_blogs',JSON.stringify(hold_blogs));
    // add_title.value = "";
    // add_textarea.value = "";
